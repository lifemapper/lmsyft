...
from specnet.tools.s2n.spnet import SpNetAnalyses
...
class SparseMatrix(_AggregateDataMatrix):
    ...
    def __init__(
        ...
        Args:
            ...
            table_type (specnet.common.constants.SUMMARY_TABLE_TYPES): type of
                aggregated data
    ...
    def init_from_stacked_data(
        ...
        Args:
            ...
            table_type (specnet.common.constants.SUMMARY_TABLE_TYPES): table type of
    ...
    def uncompress_zipped_data(
        ...
        Returns:
            ...
            table_type (specnet.common.constants.SUMMARY_TABLE_TYPES): type of table
                data
