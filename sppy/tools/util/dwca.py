...
def download_dwca(url, baseoutpath, overwrite=False, logger=None):
    ...
    if success:
        ...
        try:
            ...
            logit(logger, f"Failed on URL {url}, code = {ret_code}, reason = {reason} ({e})")
