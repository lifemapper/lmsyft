...
VALID_IDENTIFIERS = ["id", "occurrenceID", "globaluniqueidentifier"]
...
# .....................................................................................
def assemble_queue_filename(method, collection_id):
...
def move_to_queue(method, collection_id, data):
    # Write data to file system for another process to pick up and handle
    dwca_filename = assemble_queue_filename(method, collection_id)
...
def process_dwca_directory(in_directory, out_directory, error_directory):
    ...
    for dwca_filename in dwca_files:
        ...
        try:
            process_dwca(dwca_filename, collection_id=collection_id)
            shutil.move(
                dwca_filename,
